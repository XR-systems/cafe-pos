...
const fmtMoney = (n) => `$${Number(n).toLocaleString('es-MX', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`
...
export default function AdminAnaliticas() {
  ...
  const { total_sales, total_expenses, net_profit, weekly, goals } = data
  ...
  return (
    <div className="admin-content">
      ...
      <div className="admin-card">
        <h3 className="admin-card-title">Ganancia neta — últimos 7 días</h3>
            ...
            return (
              <div key={i} className="bar-col">
                ...
                <div className="bar-wrap">
                  <div
                    className={`bar ${isNeg ? 'bar-neg' : 'bar-pos'}`}
      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleAddGoal}>
          <div className="admin-form" style={{ flexWrap: 'wrap' }}>
            <input
              placeholder="Nombre de la meta (ej. Equipo nuevo)"
              value={goalForm.name}
            ...
            <input
              ...
              onChange={e => setGoalForm(f => ({ ...f, percentage: e.target.value }))}
              style={{ width: 130 }}
            />
        ...
        {/* Lista de metas */}
        {goals.length === 0 ? (
          <p style={{ textAlign: 'center', color: '#aaa', padding: '24px 0', fontSize: '0.9rem' }}>
